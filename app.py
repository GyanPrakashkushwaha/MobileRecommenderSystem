...
st.markdown('> ##### Note-If just click the recommend button again without selecting any mobiles you will get to see new mobile phones in the Other Variety of mobiles section.')
st.markdown(' ')
